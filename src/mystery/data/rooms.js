 ...
 *   coworking → the bullpen, where Yibo's body is (everyone works here)
 ...
 *                        The whole case plays at night, so the night art shows.
...
export const rooms = [
  {
    ...
    examineTargets: [
      { id: 'cw-body', label: 'THE BODY', x: 0.40, y: 0.62, flavor: 'Yibo, face-down between the desks where the whole team sits shoulder to shoulder all day. The skin says hours. The gash above his temple lines up with the desk corner — almost too well. His laptop and his phone, the things glued to his hands, are gone. Good whiskey on his breath. He didn’t drink alone.', clueId: 'the-body' },
      { id: 'cw-window', label: 'THE WINDOW', x: 0.72, y: 0.34, flavor: 'Rain sheeting down the glass, the CentralWorld signage smeared to neon soup forty floors below. Tomorrow they’ll all be down there at lunch like nothing happened. The city glitters and doesn’t care. It never does.' },
    ],
  ...
  },
  {
    ...
    examineTargets: [
      { id: 'of-desk', label: 'DAVID’S DESK', x: 0.50, y: 0.58, flavor: 'The bottom drawer doesn’t sit flush. Wedged half under the desk: a laptop with a sticker from a Singapore conference. Yibo’s. Still warm. The screen wakes to a spreadsheet of numbers that don’t match the ones David’s been showing investors.', clueId: 'retrieved-proof' },
      { id: 'of-photo', label: 'FRAMED PHOTO', x: 0.24, y: 0.72, flavor: 'Two founders at a go-kart track, arms slung over shoulders, trophy between them. Years ago, when it was still theirs together. Yibo’s face has been turned to the wall.' },
    ],
  ...
  },
  {
    ...
    examineTargets: [
      { id: 'pn-glasses', label: 'TWO GLASSES', x: 0.42, y: 0.60, flavor: 'Two whiskey glasses by the sink, set down around two. One wears Yibo’s prints. The other’s been wiped down to nothing — the only clean thing in this room. The bottle they came from is nowhere on the floor.', clueId: 'two-glasses' },
  ...
  },
  {
    ...
    examineTargets: [
      { id: 'sf-jacket', label: 'PONCHO’S JACKET', x: 0.46, y: 0.62, flavor: 'Poncho’s jacket, slung over the lounge arm since the go-kart night. In the pocket, a folded printout — a thread where he swears Yibo will rewrite his engine “over my dead body.” Damning, until you read the line at the bottom in his own hand: “we’re good. beers on me.”', clueId: 'owed-note' },
    ],
  ...
  },
  {
    ...
    examineTargets: [
      { id: 'pr-shredder', label: 'THE SHREDDER', x: 0.50, y: 0.62, flavor: 'Fresh confetti in the bin. Patient fingers reassemble it: the real growth curve beside the deck’s prettier lie, and a line in Yibo’s hand — “the round is a lie. I’m pulling the engine.” Someone disagreed, hard.', clueId: 'shredded-letter' },
    ],
  ...
  },
  {
    ...
    examineTargets: [
      { id: 'el-badge', label: 'BADGE LOG', x: 0.50, y: 0.50, flavor: 'The reader’s memory: guest badge V1 (Yibo) up at 21:40, never down. And a hole where D1 — David’s — should be, scrubbed, with a quiet re-entry at 01:55. He told everyone he karted home at eleven. Only admin and David can rewrite this log.', clueId: 'scrubbed-badge' },
    ],
